...
id_thing = [ '/w' num2str(w) '_t' num2str(Tres)...
    '_alpha' num2str(round(alpha*10)) '_f' num2str(fluo_type) '_cl' num2str(clipped) ...
...
header = {'stripe_id', 'seconds','r_on_mean','r_on_ste',...
          'k_on_mean', 'k_on_ste', 'k_off_mean','k_off_ste',};
csvwrite_with_headers([DataPath '\temporal_param_trends.csv'], ...
                       t_params_mat, header,9); 
%%
